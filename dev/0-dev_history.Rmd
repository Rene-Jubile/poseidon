...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Build package for facilitate my treatment",
    ...
    `Authors@R` = c(
      person("René-Jubilé", "Mabila", email = "jubile@mabilarene.tech", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
